...
class PanelLayout {
public:
    PanelLayout(Params params, PanelLayoutType type);
    ~PanelLayout();

    const Params& get_params() const;

    PanelLayoutType get_layout_type() const;
    void set_layout_type(PanelLayoutType type);
